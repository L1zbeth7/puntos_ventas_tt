...
import 'package:puntos_ventas_tt/controllers/almacenMenu/almacenMenu_controller.dart';
...
import 'package:puntos_ventas_tt/widgets/custom_fade_image_network.dart';
          ...
          children: [
            ...
            Expanded(
              child: TextButton.icon(
                ...
                style: StyleTexto.getButtonStyle(Colors.blue.shade900),
                onPressed: () {
  ...
  List<TableRow> _crearTabla(
    ...
    celdas.add(
      TableRow(decoration: boxDecoration, children: [
        ...
        TableCell(
          child: Container(
            padding: const EdgeInsets.all(20),
            child: Center(child: Text('Categoria', style: textColumStyle)),
          ),
        ),
        TableCell(
          child: Container(
            decoration: boxDecorationCell,
            padding: const EdgeInsets.all(20),
            child: Center(child: Text('Descripcion', style: textColumStyle)),
          ),
        ),
        TableCell(
          child: Container(
            padding: const EdgeInsets.all(20),
            child: Center(child: Text('Codigo', style: textColumStyle)),
          ),
        ),
        TableCell(
          child: Container(
            decoration: boxDecorationCell,
            padding: const EdgeInsets.all(20),
            child: Center(child: Text('Stock', style: textColumStyle)),
          ),
        ),
        TableCell(
          child: Container(
            padding: const EdgeInsets.all(20),
            child: Center(child: Text('Precio Venta', style: textColumStyle)),
          ),
        ),
        TableCell(
          child: Container(
            decoration: boxDecorationCell,
            padding: const EdgeInsets.all(20),
            child: Center(child: Text('Imagen', style: textColumStyle)),
          ),
        ),
        TableCell(
          child: Container(
            padding: const EdgeInsets.all(20),
            child: Center(child: Text('Estado', style: textColumStyle)),
          ),
        ),
      ]),
    );
    ...
    for (int i = 0; i < articulos.length; i++) {
      final boxDecorationCellConten = BoxDecoration(
        color: 1 % 2 != 0 ? Colors.black12 : Colors.white,
